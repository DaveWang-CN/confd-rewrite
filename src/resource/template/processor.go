...
func Process(config ResourceConfig) error {
...
func IntervalProcessor(config ResourceConfig, stopChan, doneChan chan bool, errChan chan error, interval int) Processor {
...
func WatchProcessor(config ResourceConfig, stopChan, doneChan chan bool, errChan chan error) Processor {
...
func getTemplateResources(config ResourceConfig) ([]*TemplateResource, error) {
	var lastError error
